...
def get_static_race_data(track_id: str, race_number: str, race_path: str, s3):
    ...
    for bi in bettingInterests:
        ...
        for bi_horse in biRunners:
            ...
            bis[biNum]['ratingStars'] = safe_get(bi_horse, ['timeform','ratingStars'])
            bis[biNum]['analystsComments'] = safe_get(bi_horse, ['timeform','analystsComments'])
            bis[biNum]['productionComment'] = safe_get(bi_horse, ['timeform','productionComment'])
            bis[biNum]['formFigures'] = safe_get(bi_horse, ['timeform','formFigures'])
            bis[biNum]['freePickNumber'] = safe_get(bi_horse, ['timeform','freePick','number'])
            bis[biNum]['freePickInfo'] = safe_get(bi_horse, ['timeform','freePick','info'])
            bis[biNum]['horseInFocus'] = safe_get(bi_horse, ['timeform','flags','horseInFocus'])
            bis[biNum]['warningHorse'] = safe_get(bi_horse, ['timeform','flags','warningHorse'])
            bis[biNum]['jockeyUplift'] = safe_get(bi_horse, ['timeform','flags','jockeyUplift'])
            bis[biNum]['trainerUplift'] = safe_get(bi_horse, ['timeform','flags','trainerUplift'])
            bis[biNum]['horsesForCoursePos'] = safe_get(bi_horse, ['timeform','flags','horsesForCoursePos'])
            bis[biNum]['horsesForCourseNeg'] = safe_get(bi_horse, ['timeform','flags','horsesForCourseNeg'])
            bis[biNum]['hotTrainer'] = safe_get(bi_horse, ['timeform','flags','hotTrainer'])
            bis[biNum]['coldTrainer'] = safe_get(bi_horse, ['timeform','flags','coldTrainer'])
            bis[biNum]['sectionalFlag'] = safe_get(bi_horse, ['timeform','flags','sectionalFlag'])
            bis[biNum]['significantImprover'] = safe_get(bi_horse, ['timeform','flags','significantImprover'])
            bis[biNum]['jockeyInForm'] = safe_get(bi_horse, ['timeform','flags','jockeyInForm'])
            bis[biNum]['clearTopRated'] = safe_get(bi_horse, ['timeform','flags','clearTopRated'])
            bis[biNum]['interestingJockeyBooking'] = safe_get(bi_horse, ['timeform','flags','interestingJockeyBooking'])
            bis[biNum]['firstTimeBlinkers'] = safe_get(bi_horse, ['timeform','flags','firstTimeBlinkers'])
            bis[biNum]['highestLastSpeedRating'] = safe_get(bi_horse, ['timeform','flags','highestLastSpeedRating'])
            bis[biNum]['tissuePriceDecimal'] = safe_get(bi_horse, ['timeform','tissuePriceDecimal'])
